...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public boolean insertIntoConsumer(String FirstName, String MiddleName, String LastName,String Address, String City, String State, String Country, String ZipCode, String Mobile, String Phone, String Gender, String Photo, String Email, String CreatedOn, String CreatedBy, String Latitude, String Longitude, String total_time)
    {
        SQLiteDatabase sdb=this.getWritableDatabase();

        sdb.execSQL("insert into Consumer(FirstName,MiddleName,LastName,Address,City,State,Country,ZipCode,Mobile,Phone, Gender,Photo,Email,CreatedOn, CreatedBy,Latitude, Longitude,StartTime ) values('" +
                FirstName + "','" + MiddleName + "','" + LastName + "','" + Address + "','" + City + "','" + State + "','" + Country + "','" + ZipCode + "','" + Mobile + "','" + Phone + "','" + Gender + "','" + Photo + "','" + Email + "','" + CreatedOn + "','" + CreatedBy + "','" + Latitude + "','" + Longitude + "','" + total_time + "')");
